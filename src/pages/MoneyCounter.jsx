        ...
        <div className="mx-auto w-full max-w-2xl rounded-sm border border-gray-200 bg-white shadow-lg">
          <header className="border-b border-gray-100 px-5 py-4">
            <div className="font-semibold text-gray-800">
              Contador de Dinero{" "}
              <span className="text-md ml-4 font-light text-slate-500">
          ...
          <div className="overflow-x-auto p-3">
            <table className="w-32 table-auto md:w-full">
              <thead className="bg-gray-50 text-xs font-semibold uppercase text-gray-400">
                <tr>
                  ...
                  <th className="p-2">
                    <div className="text-left font-semibold">Cantidad</div>
                  </th>
                  <th className="p-2">
                  ...
                  <td className="p-2">
                    <div className="text-left">
                      <input
                        ...
                        className="w-24 rounded-md border border-slate-400 md:w-3/4"
                        type="number"
                        name="1000"
                      />
                    </div>
